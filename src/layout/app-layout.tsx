...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'inventory-manager', 'financial-analyst', 'erp-administrator'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Customer', path: '/customers', entity: 'customer', service: AccessServiceEnum.PROJECT, icon: FiUsers },
    {
    ...
    { name: 'Inventory', path: '/inventories', entity: 'inventory', service: AccessServiceEnum.PROJECT, icon: FiBox },
