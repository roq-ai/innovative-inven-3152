...
import { getErpIntegrationById } from 'apiSdk/erp-integrations';
...
function ErpIntegrationViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Erp Integration Detail View
          </Text>
          {hasAccess('erp_integration', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/erp-integrations/edit/${data?.id}`} passHref legacyBehavior>
              <Button
