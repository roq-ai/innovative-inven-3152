...
import { getFinancialDetailById } from 'apiSdk/financial-details';
...
function FinancialDetailViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Financial Detail Detail View
          </Text>
          {hasAccess('financial_detail', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/financial-details/edit/${data?.id}`} passHref legacyBehavior>
              <Button
